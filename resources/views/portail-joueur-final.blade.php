            ...
            data() {
                return {
                    ...
                    notificationData: {
                        ...
                        'matches': [
                            { id: 6, title: 'Próximo Partido', message: 'Chelsea vs Manchester City - Domingo 16/03', date: '10/03/2025', priority: 'high', type: 'matches', status: 'convoqué', icon: 'fas fa-futbol', competition: 'Premier League', stadium: 'Stamford Bridge', time: '15:00', meetingTime: '14:00' },
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                ...
                                data: [76, 7{{ $player->pcmas->count() }}, {{ $player->pcmas->count() }}1, 72, 79, 77],
                                borderColor: '#3b{{ $player->pcmas->count() }}2f6',
                                backgroundColor: 'rgba(59, 130, 246, 0.1)',
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                ...
                                data: [70, 72, 75, 7{{ $player->pcmas->count() }}, {{ $player->pcmas->count() }}0, {{ $player->pcmas->count() }}2, {{ $player->pcmas->count() }}4, {{ $player->pcmas->count() }}2],
                            ...
                            scales: {
                                r: {
                                    ...
                                    ticks: { 
                                        ...
                                        color: '#6B72{{ $player->pcmas->count() }}0',
                                        font: {
                                            size: 10
                                        }
                                    }
