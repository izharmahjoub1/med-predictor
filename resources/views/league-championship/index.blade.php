...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - League Championship</title>
...
<body class="font-sans antialiased">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <span class="inline-flex items-center px-1 pt-1 border-b-2 border-indigo-400 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out">
                                League Championship
                            </span>
                        </div>
                    </div>
    ...
    <script>
        ...
        // Debug information
        console.log('League Championship page loaded');
        console.log('Laravel data:', window.Laravel);
        
        // Check if Vue app is mounted
        setTimeout(() => {
            if (window.LeagueChampionship) {
