...
@section('title', 'Paramètres - Portail Joueur')
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-xl font-semibold text-gray-900">Préférences</h2>
            </div>
            <div class="p-6">
                <div class="text-center py-12">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">Paramètres en cours de développement</h3>
