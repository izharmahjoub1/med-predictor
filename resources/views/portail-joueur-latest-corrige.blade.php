                        ...
                        <div class="relative flex-shrink-0">
                            <div class="w-32 h-32 lg:w-{{ $player->date_of_birth ? $player->date_of_birth->diffInYears(now()) : "N/A" }} lg:h-{{ $player->date_of_birth ? $player->date_of_birth->diffInYears(now()) : "N/A" }} rounded-full overflow-hidden border-4 border-white/20 shadow-2xl bg-gradient-to-br from-gray-400 to-gray-600">
                                ...
                                <img src="https://cdn.futbin.com/content/fifa23/img/players/158023.png" 
                                     ...
                                     onerror="this.onerror=null; this.src='https://www.ea.com/fifa/ultimate-team/web-app/content/24B23FDE-7835-41C2-87A2-F{{ $player->performances->count() }}3DFDB2E82/2024/fut/items/images/mobile/portraits/158023.png'; if(this.src.includes('ea.com') && this.complete && this.naturalHeight == 0) { this.style.display='none'; this.nextElementSibling.style.display='flex'; }">
            ...
            data() {
                return {
                    ...
                    offensiveStats: [
                        ...
                        { name: 'Tirs totaux', display: '{{ $player->performances->sum("shots") ?? 0 }}', percentage: {{ $player->healthRecords->latest("created_at")->heart_rate ?? "N/A" }}, teamAvg: '58.4', leagueAvg: '55.7' },
                    ...
                    physicalStats: [
                        ...
                        { name: 'Vitesse maximale', display: '{{ $player->date_of_birth ? $player->date_of_birth->diffInYears(now()) : "N/A" }}.2 km/h', percentage: 85, teamAvg: '32.1 km/h', leagueAvg: '30.8 km/h' },
                        ...
                        { name: 'Décélérations', display: '198', percentage: 85, teamAvg: '1{{ $player->healthRecords->latest("created_at")->heart_rate ?? "N/A" }}', leagueAvg: '165' },
                        { name: 'Changements direction', display: '{{ $player->performances->sum("direction_changes") ?? 0 }}', percentage: 78, teamAvg: '{{ $player->performances->sum("direction_changes") ?? 0 }}', leagueAvg: '{{ $player->healthRecords->latest("created_at")->heart_rate ?? "N/A" }}' },
                    ...
                    healthData: {
                        ...
                        vitals: [
                            ...
                            { name: 'Température', value: '{{ $player->date_of_birth ? $player->date_of_birth->diffInYears(now()) : "N/A" }}.8°', unit: 'C', icon: 'fas fa-temperature-low', color: '#f59e0b', status: 'normal' },
                        ...
                        recentMetrics: [
                            { id: 1, type: 'Poids Corporel', value: '{{ $player->healthRecords->latest("created_at")->heart_rate ?? "N/A" }}.1 kg', date: '10/03/2025', icon: 'fas fa-weight', color: '#3b82f6', trend: 'stable', change: '+0.1kg' },
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                ...
                                data: [{{ $player->performances->sum("direction_changes") ?? 0 }}, 78, 81, {{ $player->healthRecords->latest("created_at")->heart_rate ?? "N/A" }}, 79, 77],
                                borderColor: '#3b82f6',
                                backgroundColor: 'rgba(59, 130, 246, 0.1)',
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                ...
                                data: [70, {{ $player->healthRecords->latest("created_at")->heart_rate ?? "N/A" }}, 75, 78, 80, 82, 84, 82],
                                borderColor: '#8b5cf6',
                            ...
                            scales: {
                                r: {
                                    ...
                                    ticks: { 
                                        ...
                                        color: '#6B{{ $player->healthRecords->latest("created_at")->heart_rate ?? "N/A" }}80',
                                        font: {
                                            size: 10
                                        }
                                    }
