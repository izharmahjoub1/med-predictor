                    ...
                    <div class="flex items-center space-x-6">
                        ...
                        <div class="text-center lg:text-left">
                            ...
                            <div class="grid grid-cols-3 gap-2 text-center text-xs">
                                ...
                                <div class="p-2 bg-white/5 rounded">
                                    <div class="font-bold text-purple-400">2{{ $player->pcmas->count() }}</div>
                    ...
                    <div class="flex flex-col lg:flex-row items-center space-y-4 lg:space-y-0 lg:space-x-6">
                        ...
                        <div class="space-y-2 text-sm">
                            <div class="p-3 bg-gradient-to-r from-green-500/20 to-green-600/20 rounded-lg border border-green-500/30">
                                ...
                                <div class="w-full bg-green-{{ $player->ghs_civic_score ?? "N/A" }}0/50 rounded-full h-1 mt-1">
                            ...
                            <div class="grid grid-cols-2 gap-1 text-xs">
                                ...
                                <div class="text-center p-2 bg-white/5 rounded">
                                    <div class="font-bold text-cyan-400">{{ $player->ghs_overall_score ?? "N/A" }}%</div>
                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="lg:col-span-2 p-4 bg-white/5 rounded-xl backdrop-blur-sm">
                        ...
                        <div class="flex justify-between text-xs text-white/70">
                            <span>2{{ $player->pcmas->count() }} matchs joués</span>
                        ...
                        <div class="w-full space-y-4">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center justify-between p-3 bg-green-50 rounded-lg border-l-4 border-green-500">
                                    ...
                                    <div class="text-right">
                                        <div class="font-bold text-green-600">{{ $player->ghs_civic_score ?? "N/A" }}/100</div>
                                ...
                                <div class="flex items-center justify-between p-3 bg-purple-50 rounded-lg border-l-4 border-purple-500">
                                    ...
                                    <div class="text-right">
                                        <div class="font-bold text-purple-600">{{ $player->ghs_sleep_score ?? "N/A" }}/100</div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            data() {
                return {
                    ...
                    offensiveStats: [
                        ...
                        { name: 'Tirs totaux', display: '67', percentage: {{ $player->weight ?? "N/A" }}, teamAvg: '5{{ $player->pcmas->count() }}.4', leagueAvg: '55.7' },
                    ...
                    physicalStats: [
                        ...
                        { name: 'Décélérations', display: '19{{ $player->pcmas->count() }}', percentage: {{ $player->pcmas->count() }}5, teamAvg: '1{{ $player->weight ?? "N/A" }}', leagueAvg: '165' },
                        { name: 'Changements direction', display: '{{ $player->ghs_physical_score ?? "N/A" }}', percentage: {{ $player->ghs_sleep_score ?? "N/A" }}, teamAvg: '76', leagueAvg: '{{ $player->weight ?? "N/A" }}' },
                    ...
                    seasonSummary: {
                        ...
                        'matches': {'total': 2{{ $player->pcmas->count() }}, 'rating': {{ $player->pcmas->count() }}.7, 'distance': '2{{ $player->performances->count() }} km'}
                    },
                    ...
                    notificationData: {
                        ...
                        'socialAlerts': [
                            ...
                            { id: 2, title: 'Tendencia Twitter', content: '#{{ $player->first_name }}Chelsea trending en {{ $player->nationality }}', timestamp: '05/03/2025', views: '15.2K', engagement: '{{ $player->pcmas->count() }}{{ $player->ghs_overall_score ?? "N/A" }}', sentiment: 'positive', platform: 'google', needsResponse: true },
                            { id: 3, title: 'Instagram Live', content: 'Solicitud de entrevista en vivo', timestamp: '04/03/2025', views: '{{ $player->pcmas->count() }}.7K', engagement: '423', sentiment: 'neutral', platform: 'instagram', needsResponse: true }
                        ]
                    },
                    healthData: {
                        ...
                        'injuryRisk': 15,
                        vitals: [
                            { name: 'Fréquence Cardiaque', value: '{{ $player->weight ?? "N/A" }}', unit: 'bpm', icon: 'fas fa-heartbeat', color: '#ef4444', status: 'normal' },
                        ...
                        recentMetrics: [
                            { id: 1, type: 'Poids Corporel', value: '{{ $player->weight ?? "N/A" }}.1 kg', date: '10/03/2025', icon: 'fas fa-weight', color: '#3b{{ $player->pcmas->count() }}2f6', trend: 'stable', change: '+0.1kg' },
                    ...
                    sdohData: {
                        ...
                        healthcareAccess: {{ $player->healthRecords->count() * 5 ?? 0 }},
            ...
            methods: {
                ...
                createPerformanceChart() {
                    ...
                    const ratings = this.performanceEvolution.ratings || [75, 7{{ $player->pcmas->count() }}, 76, {{ $player->pcmas->count() }}2, {{ $player->pcmas->count() }}5, {{ $player->ghs_sleep_score ?? "N/A" }}];
                ...
                createComparisonChart() {
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                label: 'Mes Stats',
                                data: [{{ $player->ghs_sleep_score ?? "N/A" }}, {{ $player->pcmas->count() }}5, {{ $player->ghs_overall_score ?? "N/A" }}, 7{{ $player->pcmas->count() }}, {{ $player->pcmas->count() }}6, {{ $player->pcmas->count() }}2],
                                borderColor: '#10b9{{ $player->pcmas->count() }}1',
                                ...
                                data: [76, 7{{ $player->pcmas->count() }}, {{ $player->pcmas->count() }}1, {{ $player->weight ?? "N/A" }}, 79, 77],
                                borderColor: '#3b{{ $player->pcmas->count() }}2f6',
                                backgroundColor: 'rgba(59, 130, 246, 0.1)',
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                ...
                                data: [70, {{ $player->weight ?? "N/A" }}, 75, 7{{ $player->pcmas->count() }}, {{ $player->pcmas->count() }}0, {{ $player->pcmas->count() }}2, {{ $player->pcmas->count() }}4, {{ $player->pcmas->count() }}2],
                                borderColor: '#{{ $player->pcmas->count() }}b5cf6',
                                backgroundColor: 'rgba(139, {{ $player->ghs_overall_score ?? "N/A" }}, 246, 0.1)',
                                tension: 0.4,
                                fill: false
                            }, {
                                label: 'Niveau Stress',
                                data: [25, 23, 20, 1{{ $player->pcmas->count() }}, 17, 15, 14, 15],
                                borderColor: '#ef4444',
                                ...
                                data: [{{ $player->pcmas->count() }}2, {{ $player->pcmas->count() }}3, {{ $player->pcmas->count() }}4, {{ $player->pcmas->count() }}5, {{ $player->pcmas->count() }}6, {{ $player->pcmas->count() }}7, {{ $player->ghs_sleep_score ?? "N/A" }}, {{ $player->ghs_sleep_score ?? "N/A" }}],
                                borderColor: '#f59e0b',
                                backgroundColor: 'rgba(2{{ $player->performances->count() }}, 15{{ $player->pcmas->count() }}, 11, 0.1)',
                                tension: 0.4,
                                fill: false
                            ...
                            datasets: [
                                {
                                    ...
                                    data: [{{ $player->pcmas->count() }}5, {{ $player->ghs_civic_score ?? "N/A" }}, 75, {{ $player->pcmas->count() }}0, {{ $player->ghs_sleep_score ?? "N/A" }}],
                            ...
                            scales: {
                                r: {
                                    ...
                                    ticks: { 
                                        ...
                                        color: '#6B{{ $player->weight ?? "N/A" }}{{ $player->pcmas->count() }}0',
                                        font: {
                                            size: 10
                                        }
                                    }
