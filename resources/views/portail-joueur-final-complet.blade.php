            ...
            data() {
                return {
                    ...
                    offensiveStats: [
                        ...
                        { name: 'Tirs cadrés', display: '{{ $player->performances->sum("shots_on_target") ?? 0 }}', percentage: {{ $player->performances->sum("shots") > 0 ? 78 : 65 }}, teamAvg: '35.2', leagueAvg: '32.1' },
                        { name: 'Tirs totaux', display: '{{ $player->performances->sum("shots") ?? 0 }}', percentage: 72, teamAvg: '58.4', leagueAvg: '55.7' },
                        { name: 'Précision tirs', display: '{{ $player->performances->sum("shots") > 0 ? round(($player->performances->sum("shots_on_target") / $player->performances->sum("shots")) * 100) : 0 }}%', percentage: {{ $player->performances->sum("shots") > 0 ? 78 : 65 }}, teamAvg: '65%', leagueAvg: '62%' },
                        ...
                        { name: 'Passes clés', display: '{{ $player->performances->sum("key_passes") ?? 0 }}', percentage: {{ $player->performances->sum("shots") > 0 ? 78 : 65 }}, teamAvg: '22.1', leagueAvg: '19.8' },
                        { name: 'Centres réussis', display: '{{ $player->performances->sum("crosses") ?? 0 }}', percentage: 75, teamAvg: '{{ $player->performances->count() > 0 ? $player->performances->count() > 0 ? round($player->performances->avg("crosses"), 1) : 0 : 0 }}', leagueAvg: '13.7' },
                        { name: 'Dribbles réussis', display: '{{ $player->performances->sum("dribbles") ?? 0 }}', percentage: {{ $player->performances->sum("assists") > 0 ? 82 : 70 }}, teamAvg: '{{ $player->performances->count() }}.2', leagueAvg: '38.9' }
                    ],
                    physicalStats: [
                        { name: 'Distance parcourue', display: '{{ $player->performances->sum("distance_covered") ?? 0 }} km', percentage: {{ $player->performances->sum("shots") > 0 ? 78 : 65 }}, teamAvg: '198 km', leagueAvg: '185 km' },
                        { name: 'Vitesse maximale', display: '{{ $player->performances->max("max_speed") ?? 0 }} km/h', percentage: {{ $player->performances->sum("goals") > 0 ? 85 : 70 }}, teamAvg: '32.1 km/h', leagueAvg: '30.8 km/h' },
                        { name: 'Vitesse moyenne', display: '{{ $player->performances->avg("avg_speed") ?? 0 }} km/h', percentage: {{ $player->performances->sum("assists") > 0 ? 82 : 70 }}, teamAvg: '11.2 km/h', leagueAvg: '10.9 km/h' },
                    ...
                    technicalStats: [
                        { name: 'Précision passes', display: '88%', percentage: {{ $player->performances->sum("assists") > 0 ? 82 : 70 }}, teamAvg: '85%', leagueAvg: '82%' },
                        ...
                        { name: 'Cartons jaunes', display: '2', percentage: {{ $player->performances->sum("goals") > 0 ? 85 : 70 }}, teamAvg: '4.8', leagueAvg: '4.2' }
                    ],
                    seasonSummary: {
