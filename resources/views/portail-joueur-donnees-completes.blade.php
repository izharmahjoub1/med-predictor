        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            data() {
                return {
                    ...
                    offensiveStats: [
                        ...
                        { name: 'Passes clés', display: '28', percentage: 78, teamAvg: '22.1', leagueAvg: '19.8' },
                        { name: 'Centres réussis', display: '18', percentage: 75, teamAvg: '15.3', leagueAvg: '13.7' },
                        { name: 'Dribbles réussis', display: '76', percentage: 82, teamAvg: '45.2', leagueAvg: '38.9' }
                    ],
                    physicalStats: [
                        { name: 'Distance parcourue', display: '245 km', percentage: 78, teamAvg: '198 km', leagueAvg: '185 km' },
                        { name: 'Vitesse maximale', display: '36.2 km/h', percentage: 85, teamAvg: '32.1 km/h', leagueAvg: '30.8 km/h' },
                        { name: 'Vitesse moyenne', display: '12.3 km/h', percentage: 82, teamAvg: '11.2 km/h', leagueAvg: '10.9 km/h' },
                        { name: 'Sprints', display: '156', percentage: 82, teamAvg: '128', leagueAvg: '115' },
                        ...
                        { name: 'Changements direction', display: '76', percentage: 78, teamAvg: '76', leagueAvg: '72' },
                    ...
                    technicalStats: [
                        ...
                        { name: 'Passes longues', display: '45', percentage: 78, teamAvg: '38', leagueAvg: '35' },
                        { name: 'Centres réussis', display: '18', percentage: 75, teamAvg: '15.3', leagueAvg: '13.7' },
                    ...
                    notificationData: {
                        ...
                        'socialAlerts': [
                            ...
                            { id: 2, title: 'Tendencia Twitter', content: '#MessiChelsea trending en {{ $player->nationality }}', timestamp: '05/03/2025', views: '15.2K', engagement: '888', sentiment: 'positive', platform: 'google', needsResponse: true },
            ...
            methods: {
                ...
                createPerformanceChart() {
                    ...
                    const ratings = this.performanceEvolution.ratings || [75, 78, 76, 82, 85, 78];
