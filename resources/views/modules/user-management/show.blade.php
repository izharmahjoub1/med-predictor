                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            @if($user->status === 'active')
                                <form method="POST" action="{{ route('user-management.users.update', $user) }}" class="inline w-full">
                                    @csrf
                                    @method('PUT')
                            ...
                            @if(!$user->isSystemAdmin() && $user->id !== auth()->id())
                                <form method="POST" action="{{ route('user-management.users.destroy', $user) }}" class="inline w-full" 
