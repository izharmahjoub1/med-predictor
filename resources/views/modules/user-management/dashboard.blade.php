...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-gray-600">Manage users and FIFA Connect compliance</p>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Users by Status</h3>
                    <div class="space-y-3">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="{{ route('user-management.users.index') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">View All</a>
                </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('user-management.users.show', $user) }}" class="text-blue-600 hover:text-blue-900 mr-3">View</a>
                                    <a href="{{ route('user-management.users.edit', $user) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                </td>
                            </tr>
                            @empty
                            <tr>
        ...
        <div class="mt-8 bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <h3 class="text-lg font-medium text-gray-900 mb-4">FIFA Connect Integration Status</h3>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="flex items-center p-4 bg-green-50 rounded-lg">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-green-600">FIFA Connect API</p>
                        </div>
                    </div>
                    <div class="flex items-center p-4 bg-blue-50 rounded-lg">
                        ...
                        <div>
                            <p class="text-sm font-medium text-blue-800">Synced</p>
                            <p class="text-xs text-blue-600">{{ $stats['total_users'] }} Users</p>
                        </div>
                    </div>
                    <div class="flex items-center p-4 bg-purple-50 rounded-lg">
                        ...
                        <div>
                            <p class="text-sm font-medium text-purple-800">Compliant</p>
                            <p class="text-xs text-purple-600">FIFA Standards</p>
                        </div>
                    </div>
                </div>
            </div>
