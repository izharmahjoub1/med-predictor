...
<head>
    ...
    <title>Edit Healthcare Record</title>
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        <div class="flex-shrink-0 flex items-center">
                            <h1 class="text-xl font-semibold">Edit Healthcare Record</h1>
                        </div>
                    </div>
            ...
            <div class="px-4 py-6 sm:px-0">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <h2 class="text-lg font-semibold mb-4">Edit Healthcare Record</h2>
                        <p class="text-gray-600">This page will contain the form to edit the healthcare record.</p>
