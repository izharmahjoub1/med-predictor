            ...
            <div class="px-4 py-6 sm:px-0">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <h2 class="text-lg font-semibold mb-4">Create New Healthcare Record</h2>
                        <p class="text-gray-600">This page will contain the form to create new healthcare records.</p>
