  ...
  <div class="bg-white rounded-lg shadow-md">
    ...
    <div class="p-6 border-b border-gray-200">
      <div class="flex items-center justify-between">
        <div>
          <h2 class="text-2xl font-bold text-gray-900">{{ $t('auto.key372') }}</h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div class="bg-blue-50 p-4 rounded-lg">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              <p class="text-sm font-medium text-blue-600">{{ $t('auto.key373') }}</p>
        ...
        <div class="bg-green-50 p-4 rounded-lg">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              <p class="text-sm font-medium text-green-600">{{ $t('auto.key374') }}</p>
        ...
        <div class="bg-yellow-50 p-4 rounded-lg">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              <p class="text-sm font-medium text-yellow-600">{{ $t('auto.key375') }}</p>
        ...
        <div class="bg-red-50 p-4 rounded-lg">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              <p class="text-sm font-medium text-red-600">{{ $t('auto.key376') }}</p>
    ...
    <div class="p-6">
      ...
      <div v-if="activeTab === 'club'" class="space-y-6">
        <div class="flex items-center justify-between">
          ...
          >
            <option value="">{{ $t('auto.key377') }}</option>
        ...
        <div v-if="selectedClub" class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
              <tr>
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ $t('auto.key378') }}</th>
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ $t('auto.key379') }}</th>
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ $t('auto.key380') }}</th>
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ $t('auto.key381') }}</th>
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ $t('auto.key382') }}</th>
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ $t('auto.key383') }}</th>
              </tr>
            </thead>
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="player in clubPlayers" :key="player.id" class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  ...
                  <span v-else class="text-gray-400 text-sm">{{ $t('auto.key384') }}</span>
                </td>
      ...
      <div v-if="activeTab === 'federation'" class="space-y-6">
        <div class="flex items-center justify-between">
          ...
          <select
            ...
            class="border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
          >
            <option value="">{{ $t('auto.key385') }}</option>
        ...
        <div v-if="selectedFederation" class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="bg-gray-50 p-4 rounded-lg">
            <h4 class="text-sm font-medium text-gray-900 mb-3">{{ $t('auto.key386') }}</h4>
            <div class="space-y-2">
          ...
          <div class="bg-red-50 p-4 rounded-lg">
            <h4 class="text-sm font-medium text-red-900 mb-3">{{ $t('auto.key387') }}</h4>
            <div class="space-y-2">
      ...
      <div v-if="activeTab === 'player'" class="space-y-6">
        <div class="flex items-center justify-between">
          ...
          <select
            ...
            class="border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
          >
            <option value="">{{ $t('auto.key388') }}</option>
        ...
        <div v-if="selectedPlayer" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div class="bg-gray-50 p-4 rounded-lg">
            <h4 class="text-sm font-medium text-gray-900 mb-3">{{ $t('auto.key389') }}</h4>
            <div class="space-y-2 text-sm">
              <div><span class="font-medium">{{ $t('auto.key390') }}</span> {{ selectedPlayer.name }}</div>
              <div><span class="font-medium">{{ $t('auto.key391') }}</span> {{ selectedPlayer.position }}</div>
              <div><span class="font-medium">{{ $t('auto.key392') }}</span> {{ selectedPlayer.nationality }}</div>
              <div><span class="font-medium">{{ $t('auto.key393') }}</span> {{ selectedPlayer.current_club?.name }}</div>
              <div><span class="font-medium">{{ $t('auto.key394') }}</span> 
          ...
          <div class="lg:col-span-2 bg-gray-50 p-4 rounded-lg">
            <h4 class="text-sm font-medium text-gray-900 mb-3">{{ $t('auto.key395') }}</h4>
            <div class="space-y-3">
