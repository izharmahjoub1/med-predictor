                    ...
                    <div class="flex flex-col lg:flex-row items-center justify-between">
                        ...
                        <div class="flex-1 text-center lg:text-left mb-8 lg:mb-0">
                            <div class="flex items-center justify-center lg:justify-start mb-6">
                                ...
                                <!-- Informations -->
                                <div>
                                    <h1 class="text-3xl lg:text-5xl font-bold mb-2">{{ $player->name }}</h1>
                                    <p class="text-xl lg:text-2xl text-blue-200 mb-2">{{ $player->position }} - {{ $player->club->name ?? 'Club' }} & {{ $player->association->name ?? 'Pays' }}</p>
                            ...
                            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 max-w-2xl mx-auto lg:mx-0">
                                <div class="bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-3 border border-white border-opacity-20">
                                    <p class="text-2xl font-bold">{{ $performanceData['seasonSummary']['matches']['total'] ?? 25 }}</p>
                                    <p class="text-sm text-blue-200">Matchs</p>
                                    <p class="text-xs text-blue-300">+3 cette saison</p>
                                </div>
                                <div class="bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-3 border border-white border-opacity-20">
                                    <p class="text-2xl font-bold">{{ $performanceData['seasonSummary']['goals']['total'] ?? 15 }}</p>
                                    <p class="text-sm text-blue-200">Buts</p>
                                    <p class="text-xs text-blue-300">{{ $performanceData['seasonSummary']['goals']['average'] ?? '0.6' }}/match</p>
                                </div>
                                <div class="bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-3 border border-white border-opacity-20">
                                    <p class="text-2xl font-bold">{{ $performanceData['seasonSummary']['assists']['total'] ?? 12 }}</p>
                                    <p class="text-sm text-blue-200">Passes</p>
                                    <p class="text-xs text-blue-300">{{ $performanceData['seasonSummary']['assists']['accuracy'] ?? '85%' }} précision</p>
                                </div>
                                <div class="bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-3 border border-white border-opacity-20">
                                    <p class="text-2xl font-bold">{{ $performanceData['seasonSummary']['matches']['rating'] ?? '8.2' }}</p>
                                    <p class="text-sm text-blue-200">Note</p>
                                    <p class="text-xs text-blue-300">Top 5%</p>
                                </div>
                            </div>
                        </div>
