...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-6">
        <nav class="flex space-x-8">
            <a href="#health-records" class="border-b-2 border-blue-500 text-blue-600 py-2 px-1 text-sm font-medium">
                Dossiers de Santé
            </a>
            <a href="#pcma" class="border-b-2 border-transparent text-gray-500 hover:text-gray-700 py-2 px-1 text-sm font-medium">
                PCMA
            </a>
        </nav>
    </div>
    ...
    <!-- Dossiers de Santé -->
    <div id="health-records" class="mb-8">
                                ...
                                <div>
                                    ...
                                    @if($record->symptoms)
                                        <p class="text-sm text-gray-700 mt-2">
                                            <strong>Symptômes:</strong> {{ $record->symptoms }}
                                        </p>
                                    @endif
                                    @if($record->diagnosis)
                                    ...
                                    @if($record->treatment)
                                        <p class="text-sm text-gray-700">
                                            <strong>Traitement:</strong> {{ $record->treatment }}
                                        </p>
                                    @endif
                                    @if($record->notes)
                                        <p class="text-sm text-gray-700 mt-2">
