...
<head>
    ...
    <style>
        ...
        .stat-bar {
            height: 8px;
            background: linear-gradient({{ $player->ghs_civic_score ?? "N/A" }}deg, #10b981 0%, #34d399 100%);
            border-radius: 4px;
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-2">
                                <div class="flex justify-between items-center p-2 bg-green-50 rounded">
                                    ...
                                    <span class="font-bold text-green-600">{{ $player->ghs_physical_score ?? "N/A" }}g / 85g</span>
                                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            data() {
                return {
                    ...
                    offensiveStats: [
                        ...
                        { name: 'Tirs cadrés', display: '42', percentage: 78, teamAvg: '35.2', leagueAvg: '32.1' },
                        { name: 'Tirs totaux', display: '67', percentage: 72, teamAvg: '58.4', leagueAvg: '55.7' },
                        { name: 'Précision tirs', display: '78%', percentage: 78, teamAvg: '65%', leagueAvg: '62%' },
                        { name: 'Passes décisives', display: '8', percentage: {{ $player->ghs_civic_score ?? "N/A" }}, teamAvg: '6.8', leagueAvg: '5.9' },
                        { name: 'Passes clés', display: '28', percentage: {{ $player->ghs_sleep_score ?? "N/A" }}, teamAvg: '22.1', leagueAvg: '19.8' },
                        { name: 'Centres réussis', display: '18', percentage: 75, teamAvg: '15.3', leagueAvg: '13.7' },
                        { name: 'Dribbles réussis', display: '{{ $player->ghs_physical_score ?? "N/A" }}', percentage: {{ $player->ghs_overall_score ?? "N/A" }}, teamAvg: '45.2', leagueAvg: '38.9' }
                    ],
                    physicalStats: [
                        { name: 'Distance parcourue', display: '245 km', percentage: {{ $player->ghs_sleep_score ?? "N/A" }}, teamAvg: '198 km', leagueAvg: '185 km' },
                        { name: 'Vitesse maximale', display: '36.2 km/h', percentage: {{ $player->ghs_mental_score ?? "N/A" }}, teamAvg: '32.1 km/h', leagueAvg: '30.8 km/h' },
                        { name: 'Vitesse moyenne', display: '12.3 km/h', percentage: 82, teamAvg: '11.2 km/h', leagueAvg: '10.9 km/h' },
                        { name: 'Sprints', display: '156', percentage: {{ $player->ghs_civic_score ?? "N/A" }}, teamAvg: '128', leagueAvg: '115' },
                        { name: 'Accélérations', display: '234', percentage: 87, teamAvg: '198', leagueAvg: '185' },
                        { name: 'Décélérations', display: '198', percentage: 85, teamAvg: '172', leagueAvg: '165' },
                    ...
                    technicalStats: [
                        { name: 'Précision passes', display: '{{ $player->ghs_overall_score ?? "N/A" }}%', percentage: {{ $player->ghs_overall_score ?? "N/A" }}, teamAvg: '85%', leagueAvg: '82%' },
                        { name: 'Passes longues', display: '45', percentage: {{ $player->ghs_sleep_score ?? "N/A" }}, teamAvg: '38', leagueAvg: '35' },
                        { name: 'Centres réussis', display: '18', percentage: 75, teamAvg: '15.3', leagueAvg: '13.7' },
                        { name: 'Tacles réussis', display: '23', percentage: 82, teamAvg: '28.5', leagueAvg: '26.8' },
                        ...
                        { name: 'Fautes commises', display: '8', percentage: {{ $player->ghs_civic_score ?? "N/A" }}, teamAvg: '12.4', leagueAvg: '11.8' },
                        { name: 'Cartons jaunes', display: '2', percentage: {{ $player->ghs_mental_score ?? "N/A" }}, teamAvg: '4.8', leagueAvg: '4.2' }
                    ],
                    seasonSummary: {
                        'goals': {'total': 12, 'trend': '+3', 'avg': 0.43},
                        'assists': {'total': 8, 'trend': '+2', 'avg': 0.29},
                        'matches': {'total': 28, 'rating': 8.7, 'distance': '245 km'}
                    },
                    ...
                    notificationData: {
                        ...
                        'socialMedia': [
                            ...
                            { id: 11, title: 'Tendencia Twitter', message: '#MessiChelsea trending en {{ $player->nationality }}', date: '05/03/2025', priority: 'low', type: 'social' },
                        ...
                        'socialAlerts': [
                            ...
                            { id: 2, title: 'Tendencia Twitter', content: '#MessiChelsea trending en {{ $player->nationality }}', timestamp: '05/03/2025', views: '15.2K', engagement: '8{{ $player->ghs_overall_score ?? "N/A" }}', sentiment: 'positive', platform: 'google', needsResponse: true },
                            { id: 3, title: 'Instagram Live', content: 'Solicitud de entrevista en vivo', timestamp: '04/03/2025', views: '8.7K', engagement: '423', sentiment: 'neutral', platform: 'instagram', needsResponse: true }
                        ]
                    },
                    healthData: {
                        'globalScore': 87,
                    ...
                    dopingData: {
                        ...
                        controlHistory: [
                            { id: 1, type: 'Contrôle inopiné', date: '28/02/2025', location: 'Centre d\'entraînement', status: 'completed', result: 'négatif', substances: 'Aucune substance interdite détectée', notes: 'Contrôle standard, aucun problème détecté' },
            ...
            methods: {
                ...
                createPerformanceChart() {
                    ...
                    const ratings = this.performanceEvolution.ratings || [75, 78, 76, 82, 85, {{ $player->ghs_sleep_score ?? "N/A" }}];
                ...
                createComparisonChart() {
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                label: 'Mes Stats',
                                data: [{{ $player->ghs_sleep_score ?? "N/A" }}, 85, {{ $player->ghs_overall_score ?? "N/A" }}, 78, 86, 82],
                                borderColor: '#10b981',
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                ...
                                data: [82, 83, 84, 85, 86, 87, {{ $player->ghs_sleep_score ?? "N/A" }}, {{ $player->ghs_sleep_score ?? "N/A" }}],
                                borderColor: '#f59e0b',
                                backgroundColor: 'rgba(245, 158, 11, 0.1)',
                                tension: 0.4,
                                fill: false
                            ...
                            datasets: [
                                {
                                    ...
                                    data: [85, {{ $player->ghs_civic_score ?? "N/A" }}, 75, 80, {{ $player->ghs_sleep_score ?? "N/A" }}],
