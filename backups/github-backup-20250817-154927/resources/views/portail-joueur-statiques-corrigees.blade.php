            ...
            data() {
                return {
                    ...
                    seasonSummary: {
                        ...
                        'matches': {'total': {{ $player->matchStats->sum("goals_scored") ?? 0 }}, 'rating': 8.7, 'distance': '2{{ $player->matchStats->count() }} km'}
                    },
                    ...
                    notificationData: {
                        ...
                        'socialAlerts': [
                            ...
                            { id: 3, title: 'Instagram Live', content: 'Solicitud de entrevista en vivo', timestamp: '04/03/2025', views: '8.7K', engagement: '{{ $player->matchStats->sum("shots_on_target") ?? 0 }}3', sentiment: 'neutral', platform: 'instagram', needsResponse: true }
                        ]
                    },
                    healthData: {
                        'globalScore': 87,
