...
class StoreMatchEventRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('create', \App\Models\MatchEvent::class);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'event_type' => 'required|string|in:goal,assist,yellow_card,red_card,substitution_in,substitution_out,injury,save,missed_penalty,penalty_saved,own_goal,var_decision,free_kick_goal,header_goal,volley_goal,long_range_goal,penalty_goal,match_start,half_time,full_time,extra_time_start,extra_time_end,penalty_shootout_start,penalty_shootout_end',
            'type' => 'sometimes|string|max:100',
            'minute' => 'required|integer|min:0|max:120',
            'extra_time_minute' => 'sometimes|integer|min:0|max:30',
            'period' => 'required|string|in:first_half,second_half,extra_time_first,extra_time_second,penalty_shootout',
