...
class StorePlayerLicenseRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()->can('create', \App\Models\PlayerLicense::class);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'license_type' => 'required|string|in:professional,amateur,youth,international',
            'status' => 'sometimes|string|in:pending,active,suspended,expired,revoked',
            'issue_date' => 'sometimes|date',
            'expiry_date' => 'required|date|after:today',
            'issuing_authority' => 'required|string|max:255',
            'license_category' => 'required|string|in:A,B,C,D,E',
