...
class StoreMatchSheetRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'match_number' => 'required|string|max:50|unique:match_sheets,match_number',
            'stadium_venue' => 'required|string|max:255',
    ...
    public function messages(): array
    {
        return [
            ...
            'match_number.required' => 'Match number is required.',
            'match_number.unique' => 'This match number is already taken.',
            'stadium_venue.required' => 'Stadium venue is required.',
            'kickoff_time.required' => 'Kickoff time is required.',
            'kickoff_time.after' => 'Kickoff time must be in the future.',
