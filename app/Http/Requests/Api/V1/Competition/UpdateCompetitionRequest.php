...
class UpdateCompetitionRequest extends FormRequest
{
    ...
    {
        $competitionId = $this->route('competition')->id ?? null;
        ...
        return [
            'name' => [
                ...
                'string',
                'max:255',
                Rule::unique('competitions', 'name')->ignore($competitionId)
            ],
            'description' => 'sometimes|nullable|string|max:1000',
            'type' => 'sometimes|string|in:league,cup,tournament,friendly',
            'format' => 'sometimes|string|in:round_robin,knockout,group_stage,mixed',
            'status' => 'sometimes|string|in:active,inactive,draft,archived',
            'association_id' => 'sometimes|exists:associations,id',
            'start_date' => 'sometimes|date',
            'end_date' => 'sometimes|date|after:start_date',
            'registration_deadline' => 'sometimes|nullable|date|before:start_date',
            'max_teams' => 'sometimes|nullable|integer|min:2|max:100',
            'min_teams' => [
                'sometimes',
                'nullable',
                'integer',
            ...
            'age_group' => 'sometimes|nullable|string|in:u8,u10,u12,u14,u16,u18,u21,senior,mixed',
            'gender' => 'sometimes|nullable|string|in:male,female,mixed',
            'venue_type' => 'sometimes|nullable|string|in:indoor,outdoor,both',
            ...
            'banner' => 'sometimes|nullable|image|mimes:jpeg,png,jpg,gif|max:5120',
            'is_featured' => 'sometimes|boolean',
            'is_public' => 'sometimes|boolean',
            'requires_approval' => 'sometimes|boolean',
            'auto_approve_teams' => 'sometimes|boolean',
            'allow_substitutions' => 'sometimes|boolean',
            'max_substitutions' => 'sometimes|nullable|integer|min:0|max:10',
            'match_duration' => 'sometimes|nullable|integer|min:30|max:120',
            'extra_time' => 'sometimes|boolean',
            'penalties' => 'sometimes|boolean',
            'var_enabled' => 'sometimes|boolean',
            'streaming_enabled' => 'sometimes|boolean',
            'ticket_sales_enabled' => 'sometimes|boolean',
            'sponsorship_enabled' => 'sometimes|boolean',
    ...
    public function messages(): array
    {
        return [
            ...
            'min_teams.min' => 'Minimum teams must be at least 2.',
