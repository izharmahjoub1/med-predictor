<?php
/**
 * Test Route Voice - Test de la route /test-pcma-create
 */

echo "=== Test Route Voice - Route de Test PCMA ===\n\n";

echo "🎯 **Test de la route /test-pcma-create (sans authentification)**\n\n";

// Test de la route de test
$testUrl = 'http://localhost:8080/test-pcma-create';
...
if ($httpCode == 200) {
    ...
    echo "\n6. Début de la réponse (300 premiers caractères) :\n";
...
echo "\n=== Résumé ===\n";
echo "🎯 **Objectif** : Vérifier que la route de test fonctionne\n";
...
echo "\n🎉 **Test de la route de test terminé !**\n";
?>
